...
const FreelancerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        setLoading(true);
        setTimeout(async () => {
          let response = await Userservice.checkfreelancer(email,password);
          console.log(response);
          setLoading(false);
          if(response.data) {
            setUser({id:response.data.id,name:response.data.name,email:response.data.email,password:response.data.password,role:'freelancer'});
